# MO2 Custom Filters - copyright and licence
...
The plugin reuses, at run time, three of MO2's own icons (`:/MO/gui/checked-checkbox`, `unchecked-checkbox`,
`indeterminate-checkbox`) so its tick boxes look exactly like MO2's filter list; the images are not shipped here.
The way each MO2 filter criterion is counted follows MO2's `src/modlistsortproxy.cpp` (2.5.2), re-expressed in Python.

Source code: https://github.com/ApocryphaRealm/MO2CustomFilters
